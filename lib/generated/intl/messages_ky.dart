...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(error) => "Тастыктоо жөнөтүүдө ката: ${error}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "addAnimal": MessageLookupByLibrary.simpleMessage("Мал кошуу"),
    ...
    "addingTitle": MessageLookupByLibrary.simpleMessage("Картаны кошуу"),
    "ageLabel": MessageLookupByLibrary.simpleMessage("Жашы"),
    "alreadyHaveAccount": MessageLookupByLibrary.simpleMessage(
      "Аккаунтуңуз барбы?",
    ),
    "animalAddedSuccessfully": MessageLookupByLibrary.simpleMessage(
      "Мал ийгиликтүү кошулду",
    ),
    ...
    "animalNameLabel": MessageLookupByLibrary.simpleMessage("Жаныбардын аты"),
    "animalOwnerLabel": MessageLookupByLibrary.simpleMessage("Ээси"),
    "animalPassportTitle": MessageLookupByLibrary.simpleMessage(
      "Жаныбардын паспорту",
    ),
    "animalSpeciesLabel": MessageLookupByLibrary.simpleMessage("Түрү"),
    "animalVaccinationsTitle": MessageLookupByLibrary.simpleMessage("Эмдөөлөр"),
    "appBackTooltip": MessageLookupByLibrary.simpleMessage("Артка"),
    "appBarNotificationsTooltip": MessageLookupByLibrary.simpleMessage(
      "Эскертмелер",
    ),
    "appBarSearchTooltip": MessageLookupByLibrary.simpleMessage("Издөө"),
    "appBarSettingsTooltip": MessageLookupByLibrary.simpleMessage("Жөндөөлөр"),
    "appTitle": MessageLookupByLibrary.simpleMessage("Email даректи ырастоо"),
    "birthDate": MessageLookupByLibrary.simpleMessage("Туулган күнү"),
    "bottomNavFarm": MessageLookupByLibrary.simpleMessage("Ферма"),
    "bottomNavFeeds": MessageLookupByLibrary.simpleMessage("Тоюттар"),
    ...
    "breedAlpine": MessageLookupByLibrary.simpleMessage("Альпия"),
    "breedAngus": MessageLookupByLibrary.simpleMessage("Ангус"),
    "breedAyrshire": MessageLookupByLibrary.simpleMessage("Айршыр"),
    "breedBlackPied": MessageLookupByLibrary.simpleMessage("Кара ала"),
    "breedBoer": MessageLookupByLibrary.simpleMessage("Боер"),
    ...
    "breedHerefordWhitehead": MessageLookupByLibrary.simpleMessage("Акбаш"),
    "breedHolstein": MessageLookupByLibrary.simpleMessage("Гольштейн"),
    "breedJersey": MessageLookupByLibrary.simpleMessage("Жерси"),
    "breedLabel": MessageLookupByLibrary.simpleMessage("Тукуму"),
    "breedLimousin": MessageLookupByLibrary.simpleMessage("Лимузин"),
    "breedMerino": MessageLookupByLibrary.simpleMessage("Меринос"),
    "breedNubian": MessageLookupByLibrary.simpleMessage("Нубия"),
    "breedPrecos": MessageLookupByLibrary.simpleMessage("Прекос"),
    "breedRomanov": MessageLookupByLibrary.simpleMessage("Романов"),
    "breedSaanen": MessageLookupByLibrary.simpleMessage("Заанен"),
    "breedSimmental": MessageLookupByLibrary.simpleMessage("Симментал"),
    "breedTexel": MessageLookupByLibrary.simpleMessage("Тексель"),
    "breedToggenburg": MessageLookupByLibrary.simpleMessage("Тоггенбург"),
    "bull": MessageLookupByLibrary.simpleMessage("Буктар"),
    "bullet1": MessageLookupByLibrary.simpleMessage(
      "1. Интерфейс тилін тандаңыз — орусча же англисче.",
    ),
    "bullet2": MessageLookupByLibrary.simpleMessage(
      "2. Электрондук почта жана сырсөз аркылуу катталыңыз.",
    ),
    "bullet3": MessageLookupByLibrary.simpleMessage(
      "3. Же Google аккаунту менен кирүү — ылдам жана ыңгайлуу.",
    ),
    ...
    "cardDateLabel": MessageLookupByLibrary.simpleMessage("Датасы:"),
    "cardLearnMoreButton": MessageLookupByLibrary.simpleMessage(
      "Көбүрөөк билүү",
    ),
    "cardNameHint": MessageLookupByLibrary.simpleMessage("Аты"),
    "cardNameLabel": MessageLookupByLibrary.simpleMessage("Карта аты"),
    "cardNumberHint": MessageLookupByLibrary.simpleMessage(
      "XXXX   XXXX   XXXX   XXXX",
    ),
    "cardNumberLabel": MessageLookupByLibrary.simpleMessage("Карта номери"),
    "cardPriceLabel": MessageLookupByLibrary.simpleMessage("Баасы:"),
    "cardPublishedOnLabel": MessageLookupByLibrary.simpleMessage("Жарыяланды:"),
    "cardStatusLabel": MessageLookupByLibrary.simpleMessage("Статусу:"),
    "cardViewDetailsButton": MessageLookupByLibrary.simpleMessage(
      "Кеңири маалымат",
    ),
    "cattleType": MessageLookupByLibrary.simpleMessage("Малдын түрү"),
    "changeCard": MessageLookupByLibrary.simpleMessage("Картаны өзгөртүү"),
    "changePassword": MessageLookupByLibrary.simpleMessage("Сырсөздү өзгөртүү"),
    "changePasswordButton": MessageLookupByLibrary.simpleMessage("Өзгөртүү"),
    ...
    "chatbotErrorOccurred": MessageLookupByLibrary.simpleMessage(
      "Ката кетти. Сураныч, кийинчерээк кайра аракет кылыңыз.",
    ),
    "chatbotScreenTitle": MessageLookupByLibrary.simpleMessage("Колдоо чаты"),
    "chatbotSendButtonTooltip": MessageLookupByLibrary.simpleMessage("Жөнөтүү"),
    "chatbotThinking": MessageLookupByLibrary.simpleMessage("Ойлонуп жатам..."),
    "chatbotTypeMessageHint": MessageLookupByLibrary.simpleMessage(
      "Билдирүүңүздү териңиз...",
    ),
    "chatbotWelcomeMessage": MessageLookupByLibrary.simpleMessage(
      "Саламатсызбы! Бүгүн сизге кантип жардам бере алам?",
    ),
    "checkYourEmail": MessageLookupByLibrary.simpleMessage(
      "Сураныч, почтаңызды текшериңиз",
    ),
    "closingStatement": MessageLookupByLibrary.simpleMessage(
      "CYCLONE фермерчиликти түшүнүктүү, эффективдүү жана заманбап кылат. Бардык башкаруу сиздин колуңузда.",
    ),
    "confirmButton": MessageLookupByLibrary.simpleMessage("Тастыктоо"),
    ...
    "confirmSubmitButton": MessageLookupByLibrary.simpleMessage("Жөнөтүү"),
    "confirmYourEmail": MessageLookupByLibrary.simpleMessage(
      "Email даректи ырастоо",
    ),
    "confirmationSendError": m0,
    "confirmationSent": m1,
    "cow": MessageLookupByLibrary.simpleMessage("Уйлар"),
    "cows": MessageLookupByLibrary.simpleMessage("Уй"),
    "createHerdError": MessageLookupByLibrary.simpleMessage(
      "Топ түзүүдө ката кетти",
    ),
    "createItemTitle": MessageLookupByLibrary.simpleMessage(
      "Жаңы элемент түзүү",
    ),
    "createNewButton": MessageLookupByLibrary.simpleMessage("Жаңы түзүү"),
    "createPasswordTitle": MessageLookupByLibrary.simpleMessage(
      "Сырсөздү ойлоп табыңыз",
    ),
    ...
    "detailsTitle": MessageLookupByLibrary.simpleMessage(
      "Мал жөнүндө маалымат",
    ),
    "dividerDescription": MessageLookupByLibrary.simpleMessage(
      "CYCLONE — фермерлерге азыктандырууну жөнөкөйлөтүүгө, малдын өсүшүн көзөмөлдөөгө жана запастарды башкарууга жардам берген тиркеме. Бардыгы бир жерде, кагаз жумушсуз.",
    ),
    "drawerAbout": MessageLookupByLibrary.simpleMessage("Биз жөнүндө"),
    "drawerAddAccount": MessageLookupByLibrary.simpleMessage("Аккаунт кошуу"),
    "drawerHome": MessageLookupByLibrary.simpleMessage("Башкы бет"),
    "drawerInstructions": MessageLookupByLibrary.simpleMessage("Нускамалар"),
    "drawerLanguage": MessageLookupByLibrary.simpleMessage("Тил"),
    "drawerLogout": MessageLookupByLibrary.simpleMessage("Чыгуу"),
    "drawerProfile": MessageLookupByLibrary.simpleMessage("Профиль"),
    "drawerSettings": MessageLookupByLibrary.simpleMessage("Жөндөөлөр"),
    "drawerShop": MessageLookupByLibrary.simpleMessage("Дүкөн"),
    "drawerSoon": MessageLookupByLibrary.simpleMessage(
    ...
    "duration15min": MessageLookupByLibrary.simpleMessage("15 мүнөт"),
    "duration20min": MessageLookupByLibrary.simpleMessage("20 мүнөт"),
    "duration4min": MessageLookupByLibrary.simpleMessage("4 мүнөт"),
    "duration5min": MessageLookupByLibrary.simpleMessage("5 мүнөт"),
    "editDialog_cancel": MessageLookupByLibrary.simpleMessage("Жокко чыгаруу"),
    "editDialog_hint": MessageLookupByLibrary.simpleMessage("Сан киргизиңиз"),
    "editDialog_insufficientFeed": MessageLookupByLibrary.simpleMessage(
      "Кампада жетишсиз жем",
    ),
    "editDialog_invalidNumber": MessageLookupByLibrary.simpleMessage(
      "Туура сан киргизиңиз",
    ),
    "editDialog_label": MessageLookupByLibrary.simpleMessage(
      "Жаңы маанини киргизиңиз",
    ),
    "editDialog_noStorage": MessageLookupByLibrary.simpleMessage(
      "Кампа табылган жок",
    ),
    "editDialog_save": MessageLookupByLibrary.simpleMessage("Сактоо"),
    ...
    "emailVerificationTitle": MessageLookupByLibrary.simpleMessage(
      "Email дарегиңизди тастыктаңыз",
    ),
    "english": MessageLookupByLibrary.simpleMessage("Англисче"),
    "enterGender": MessageLookupByLibrary.simpleMessage("Жынысын киргизиңиз"),
    ...
    "financeExpensesLabel": MessageLookupByLibrary.simpleMessage("Чыгымдар"),
    "financeGenerateReportButton": MessageLookupByLibrary.simpleMessage(
      "Отчет түзүү",
    ),
    "financeIncomeLabel": MessageLookupByLibrary.simpleMessage("Түшүүлөр"),
    ...
    "healthGood": MessageLookupByLibrary.simpleMessage("Жакшы"),
    "healthLabel": MessageLookupByLibrary.simpleMessage("Ден соолук"),
    "healthMedium": MessageLookupByLibrary.simpleMessage("Орточо"),
    "healthPoor": MessageLookupByLibrary.simpleMessage("Начар"),
    "healthStatus": MessageLookupByLibrary.simpleMessage("Саламаттык абалы"),
    "herd": MessageLookupByLibrary.simpleMessage("табылгасы"),
    ...
    "instructionCardMainScreenDescription":
        MessageLookupByLibrary.simpleMessage(
          "Экрандын негизги бөлүктөрү жана функциялары жөнүндө сүрөттөмө.",
        ),
    ...
    "instructionCardTechPassportDescription":
        MessageLookupByLibrary.simpleMessage(
          "Жаныбардын тех паспорту кантип кошулат.",
        ),
    ...
    "instructionCardWeightTrackingDescription":
        MessageLookupByLibrary.simpleMessage(
          "Жаныбарлардын салмак өзгөрүшүн кантип көзөмөлдөө.",
        ),
    ...
    "instructionContactSupport": MessageLookupByLibrary.simpleMessage(
      "Колдоо кызматымен байланышуу",
    ),
    "instructionFaqA1": MessageLookupByLibrary.simpleMessage(
      "Ж1: Сиз ... аркылуу ... кыла аласыз",
    ),
    ...
    "introDoneButton": MessageLookupByLibrary.simpleMessage("Даяр"),
    "introNextButton": MessageLookupByLibrary.simpleMessage("Андан ары"),
    "introSkipButton": MessageLookupByLibrary.simpleMessage("Өткөрүп жиберүү"),
    "introSlide1Text": MessageLookupByLibrary.simpleMessage(
      "Сиз үчүн ылайыкташтырылган укмуштуу функцияларды жана мазмунду табыңыз.",
    ),
    "introSlide1Title": MessageLookupByLibrary.simpleMessage(
      "Биздин тиркемеге кош келиңиз!",
    ),
    "introSlide2Text": MessageLookupByLibrary.simpleMessage(
      "Оңой чабыттаңыз жана үзгүлтүксүз тажрыйбадан ырахат алыңыз.",
    ),
    "introSlide2Title": MessageLookupByLibrary.simpleMessage("Колдонууга оңой"),
    "introSlide3Text": MessageLookupByLibrary.simpleMessage(
      "Биздин коомчулукка кошулуп, бүгүн саякатыңызды баштаңыз.",
    ),
    "introSlide3Title": MessageLookupByLibrary.simpleMessage("Баштоо"),
    "introTitle": MessageLookupByLibrary.simpleMessage(
      "CYCLONE — ферма башкарууда сиздин санариптик жардамчыңыз",
    ),
    ...
    "itemDescriptionLabel": MessageLookupByLibrary.simpleMessage("Сүрөттөмө"),
    "itemImageUploaded": MessageLookupByLibrary.simpleMessage("Сүрөт жүктөлдү"),
    "itemNameHint": MessageLookupByLibrary.simpleMessage(
      "Элементтин аталышын киргизиңиз",
    ),
    "itemNameLabel": MessageLookupByLibrary.simpleMessage("Элементтин аталышы"),
    "itemNoImageSelected": MessageLookupByLibrary.simpleMessage(
      "Сүрөт тандалган жок",
    ),
    "itemPriceHint": MessageLookupByLibrary.simpleMessage("Баасын киргизиңиз"),
    "itemPriceLabel": MessageLookupByLibrary.simpleMessage("Баасы"),
    ...
    "mainScreenAppBarGreeting": MessageLookupByLibrary.simpleMessage("Салам, "),
    ...
    "postalCodeLabel": MessageLookupByLibrary.simpleMessage("Почта индекси"),
    "profileChangePasswordButton": MessageLookupByLibrary.simpleMessage(
      "Сырсөздү өзгөртүү",
    ),
    "profileDialogCancel": MessageLookupByLibrary.simpleMessage(
      "Жокко чыгаруу",
    ),
    "profileDialogConfirm": MessageLookupByLibrary.simpleMessage("Ырастоо"),
    ...
    "profileSignOutButton": MessageLookupByLibrary.simpleMessage("Чыгуу"),
    ...
    "resendVerification": MessageLookupByLibrary.simpleMessage(
      "Билдирүүнү кайра жөнөтүү",
    ),
    "resetPasswordTitle": MessageLookupByLibrary.simpleMessage(
      "Сырсөздү баштапкы абалга келтирүү",
    ),
    ...
    "saving": MessageLookupByLibrary.simpleMessage("Сакталып жатат..."),
    "selectBirthDate": MessageLookupByLibrary.simpleMessage(
      "Туулган күндү тандаңыз",
    ),
    "selectBreed": MessageLookupByLibrary.simpleMessage("Породаны тандаңыз"),
    "selectButton": MessageLookupByLibrary.simpleMessage("Тандоо"),
    "selectCattleType": MessageLookupByLibrary.simpleMessage(
      "Малдын түрүн тандаңыз",
    ),
    "selectHealthStatus": MessageLookupByLibrary.simpleMessage(
      "Саламаттык абалын тандаңыз",
    ),
    "sendEmailButton": MessageLookupByLibrary.simpleMessage("Кат жөнөтүү"),
    ...
    "shopFilterButton": MessageLookupByLibrary.simpleMessage("Чыпка"),
    "shopNewArrivals": MessageLookupByLibrary.simpleMessage("Жаңы түшкөндөр"),
    "shopScreenTitle": MessageLookupByLibrary.simpleMessage("Дүкөн"),
    "shopSearchHint": MessageLookupByLibrary.simpleMessage(
      "Товарларды издөө...",
    ),
    "shopSortByButton": MessageLookupByLibrary.simpleMessage("Сорттоо"),
    "stadoCreated": MessageLookupByLibrary.simpleMessage(
      "Топ ийгиликтүү түзүлдү!",
    ),
    "stadoNumber": MessageLookupByLibrary.simpleMessage("Топ номери"),
    "startQuestion": MessageLookupByLibrary.simpleMessage(
      "Кайдан баштоо керек?",
    ),
    ...
    "stemScienceCategory": MessageLookupByLibrary.simpleMessage("Илим"),
    "stemScreenTitle": MessageLookupByLibrary.simpleMessage("STEM Бөлүмү"),
    ...
    "subpageDefaultTitle": MessageLookupByLibrary.simpleMessage("Деталдар"),
    "subpageSectionTitle": MessageLookupByLibrary.simpleMessage(
      "Бөлүмдүн аталышы",
    ),
    "successTitle": MessageLookupByLibrary.simpleMessage("Ийгилик"),
    "table": MessageLookupByLibrary.simpleMessage("Таблица"),
    "tableHeaderColumn1": MessageLookupByLibrary.simpleMessage("1-Колоонка"),
    "tableHeaderColumn2": MessageLookupByLibrary.simpleMessage("2-Колоонка"),
    "tableHeaderColumn3": MessageLookupByLibrary.simpleMessage("3-Колоонка"),
    "tableNextPage": MessageLookupByLibrary.simpleMessage("Кийинки"),
    ...
    "tableTitle": MessageLookupByLibrary.simpleMessage("Тоют таблицасы"),
    "tagNumber": MessageLookupByLibrary.simpleMessage("Мөөр номери"),
    ...
    "userNotFoundError": MessageLookupByLibrary.simpleMessage(
      "Ката: Учурдагы колдонуучу табылган жок.",
    ),
    "valueColumn": MessageLookupByLibrary.simpleMessage("Маани"),
    "verifyIdButton": MessageLookupByLibrary.simpleMessage("ID\'ни текшерүү"),
    "weight": MessageLookupByLibrary.simpleMessage("Салмагы (кг)"),
    "weightLabel": MessageLookupByLibrary.simpleMessage("Салмагы"),
